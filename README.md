...
| **Apple Silicon** | Experimental | Qwen3-ASR and MOSS-Transcribe-Diarize support native MLX and Torch MPS on macOS arm64. Install with [`install.sh`](./install.sh), then follow the [Qwen3-ASR](./docs/cookbook/qwen3_asr.md#apple-silicon-mlx) or [MOSS-TD](./docs/cookbook/moss_transcribe_diarize.md#apple-silicon-mlx-and-torch-mps) guide. |
