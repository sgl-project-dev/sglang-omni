...
| **Apple Silicon** | Experimental | Qwen3-ASR and MOSS-TTS Local run through native MLX or Torch MPS. Install with [`install.sh`](./install.sh) and follow the [Qwen3-ASR](./docs/cookbook/qwen3_asr.md#apple-silicon-mlx) or [MOSS-TTS Local](./docs/cookbook/moss_tts_local.md#apple-silicon-mlx-and-torch-mps) guide. |
