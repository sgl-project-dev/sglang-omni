...
"""Small compatibility facade for CUDA/MUSA model-owned graph paths.

This module owns the CUDA-like stream, event, allocator, and graph calls used
by model implementations. The platform-level graph backend is a separate
abstraction for the generic capture path.
"""
