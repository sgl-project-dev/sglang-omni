...
class OmniScheduler:
    ...
    def _init_upstream_scheduler_components(self) -> None:
        ...
        self.load_inquirer = SchedulerLoadInquirer(
            ...
            # Upstream reads both of these while estimating waiting uncached
            # tokens; they are supplied from the same objects upstream's own
            # Scheduler.init_load_inquirer() uses.
